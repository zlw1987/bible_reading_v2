...
LEGACY_RUNTIME_NOTE = (
    ...
    "V1 legacy BibleStudySession app runtime and the V1 Django Admin surface "
    "are retired; any remaining V1 rows are pilot/archive cleanup and "
    "schema-retirement context only. V2 Bible Study meeting visibility is "
    "structure-native through BibleStudyMeetingAudienceScope, and Bible Study "
    "generation stays structure-native through generation_key and anchor_unit, "
    "still resolving active SmallGroup rows via SmallGroup.church_structure_unit "
    "for eligible-group helpers. The legacy Profile.small_group field was "
...
STRUCTURE_UNIT_NOTE = (
    ...
    "meeting visibility is structure-native through "
    "BibleStudyMeetingAudienceScope, generation_key, and anchor_unit; Bible "
    "Study still resolves selected units to eligible active SmallGroup rows via "
    "SmallGroup.church_structure_unit for generation helpers. "
...
MEMBERSHIP_NOTE = (
    ...
    "PROFILE-SG-FIELD-RETIRE.1A, and V1 legacy BibleStudySession app runtime "
    "is retired. Zero-row ServiceEvents fail closed for ordinary "
