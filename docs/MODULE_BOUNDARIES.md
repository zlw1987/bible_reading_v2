...
the member-facing month grid and day detail UI, and `CHURCH-CALENDAR.1D-A`
prepared closure docs/checklist plus a missing focused regression test. Manual
