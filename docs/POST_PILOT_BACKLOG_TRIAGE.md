...
- Large deferred items remain deferred pending real pilot feedback. MO-S.2 required-team data now exists, but assignment coverage display, automatic scheduling, availability, swaps, reminders, checklist, notifications, attendance, Community Activities, audience filtering, and consumer migration remain deferred unless separately planned.
