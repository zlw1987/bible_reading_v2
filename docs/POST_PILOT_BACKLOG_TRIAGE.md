...
43. Later: the SE-AS.5 staff audience selector and future Community Activities reuse the same `ChurchStructureUnit` audience-scope foundation; neither is authorized by SE-AS.4 completion.
...
- SE-AS.5 Staff Audience Selector UI and Display. Future, separately approved milestone; not bundled with CS-MAP work or Community Activities.
...
- Large deferred items remain deferred pending real pilot feedback. MO-S.4 manual team-leader scheduling, MO-S.4A semantic cleanup, MO-S.5A rotation anchor metadata, MO-S.5B limited copy-forward suggestions, SE-AS.1 ServiceEvent audience-scope planning, the SE-AS.2 ServiceEventAudienceScope model-only foundation, and SE-AS.4 runtime visibility with legacy fallback now exist, but automatic scheduling, availability, swaps, reminders, checklist, notifications, attendance, Community Activities, the SE-AS.5 staff UI selector, audience editing/display workflow, and consumer migration remain deferred unless separately planned and approved.
