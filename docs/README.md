...
| Generic deployment configuration | [`GENERIC_DEPLOYMENT_CONFIGURATION_ARCHITECTURE.md`](GENERIC_DEPLOYMENT_CONFIGURATION_ARCHITECTURE.md) | Frozen, runtime-unimplemented architecture for stable Ministry Team identity, first-class Service Profiles, explicit profile defaults and materialization, opt-in deployment adapters, and future external-system mapping. |
