...
- CS-MAP.2 Read-Only Staff Structure Map + Mapping Health. Completed at `/staff/structure/` as a read-only staff page with descendant-inclusive covered-member counts, current data mapping context, and setup-readiness indicators.
