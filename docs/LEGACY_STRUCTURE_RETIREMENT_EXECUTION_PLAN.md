...
11. Run `audit_legacy_structure_object_row_retirement --verbose --limit 30`
   ...
   handled. After LEGACY-OBJECT-SURFACE-NARROW.1A, the audit explicitly reports
   remaining object rows as final table-retirement blockers, not ordinary-member
