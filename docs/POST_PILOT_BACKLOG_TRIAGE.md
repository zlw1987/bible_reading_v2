...
- MO-S.5 Limited Rotation Helper / Copy-Forward Workflow, only after manual workflow is proven.
...
- Large deferred items remain deferred pending real pilot feedback. MO-S.1 is now recorded as real near-term P2 ministry operations feedback, but automatic scheduling, availability, swaps, reminders, checklist, notifications, and Community Activities remain deferred unless separately planned.
