...
| Sunday Ministry Scheduling | [`SUNDAY_MINISTRY_SCHEDULING_PLAN.md`](SUNDAY_MINISTRY_SCHEDULING_PLAN.md) | MO-S.6A docs-only plan for a permission-safe Sunday event-by-team board, Worship-led context and reviewable pairing suggestions, controlled Excel event/anchor import, identity-safe later assignment import, and explicit deferred work. |
