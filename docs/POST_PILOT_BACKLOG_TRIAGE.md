...
- Large deferred items remain deferred pending real pilot feedback. MO-S.3 read-only assignment coverage display now exists, but automatic scheduling, availability, swaps, reminders, checklist, notifications, attendance, Community Activities, audience filtering, and consumer migration remain deferred unless separately planned.
