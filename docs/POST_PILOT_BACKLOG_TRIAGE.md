...
- Large deferred items remain deferred pending real pilot feedback. MO-S.4 manual team-leader scheduling now exists, but automatic scheduling, copy-forward, availability, swaps, reminders, checklist, notifications, attendance, Community Activities, audience filtering, and consumer migration remain deferred unless separately planned.
