...
- Same-type event scheduling workflow, now recorded as MO-S.4 future ministry scheduling work
...
- MO-S.4 team-leader scheduling workspace for same-type events should follow coverage display if scheduling workflow work continues.
...
Large deferred items remain deferred pending feedback. MO-S.3 now displays required-team coverage read-only, but Checklist V1 remains deferred unless pilot feedback proves checklist need separately from required-team coverage.
...
- Reminder automation
- Checklist engine
- Community Activities before MO-S.4 is considered
